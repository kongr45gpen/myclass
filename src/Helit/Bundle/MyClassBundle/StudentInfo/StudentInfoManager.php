...
namespace Helit\Bundle\MyClassBundle\StudentInfo;

use Doctrine\ORM\EntityManager;
use Helit\Bundle\MyClassBundle\Entity\Separation;
use Helit\Bundle\MyClassBundle\Entity\SchoolClass;
...
class StudentInfoManager
{
    ...
    public function getClass(Separation $separation)
    {
        return $this->entityManager
            ->getRepository('HelitMyClassBundle:SchoolClass')
